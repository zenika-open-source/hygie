...
import { CheckVulnerabilitiesRule } from '../../src/rules/checkVulnerabilities.rule';
...
describe('RulesService', () => {
  ...
  beforeAll(async () => {
    ...
    checkVulnerabilitiesRule.options = {
      ...
      packageLockUrl:
        'https://raw.githubusercontent.com/zenika-open-source/hygie/master/package-lock.json',
    };
  });
